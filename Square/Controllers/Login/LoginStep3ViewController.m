...
#import "LoginStep3ViewController.h"
#import "RMStepsController.h"
#import "TFHpple.h"
#import "AFNetworking.h"
AFHTTPRequestOperationManager *AFHROMs;
@interface LoginStep3ViewController ()

@end

@implementation LoginStep3ViewController
...
- (IBAction)nextStepTapped:(id)sender {
    [self acquireData:[Config getUserName]with:[Config getPassWord]];
